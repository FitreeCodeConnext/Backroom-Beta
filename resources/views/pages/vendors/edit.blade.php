        ...
        <div class="grid gap-6 mb-4 md:grid-cols-3">
            @foreach ($datagroup as $item)
                <div>
                    ...
                    <input type="text" id="text" name="" placeholder="0000001"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        value="{{ $item['vendor_id'] }}" required />
                </div>
                <div>
                    ...
                    <select name=""
                        ...
                        <option value="{{ $item['branch_id'] }}" <?php echo $item['branch_id'] === $b_id ? 'selected' : ''; ?>>{{ $item['branch_id'] }}</option>
                    </select>
                </div>
                <div>
                    ...
                    <select name="" id="text-id-no"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <option selected disabled>เลือก</option>
                        @foreach ($terminal_info as $terminal)
                            <option value="{{ $terminal['term_id'] }}" <?php echo $item['term_id'] === $terminal['term_id'] ? 'selected' : ''; ?>>{{ $terminal['term_id'] }}
                            </option>
                        @endforeach
                ...
                <div>
                    ...
                    <input type="text" id="text-no" name="" placeholder="1, 2..."
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        value="{{ $item['term_seq'] }}" required />
                </div>
                <div>
                    ...
                    <div class="relative">
                        <input type="datetime-local"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="12-07-2024" value="{{ $item['issuedate'] }}">
                    </div>
                </div>
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="datetime-local"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="12-07-2024" value="{{ $item['validdate'] }}">
                    </div>
                </div>
                <div>
                    <label for="text-vendor"
                        class="mb-2 text-sm font-medium text-gray-900 dark:text-white">ชื่อร้านค้า</label>
                    <input type="text" id="text-vendor" name="" placeholder="ร้านข้าวแกง ..."
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        value="{{ $item['vendor_name'] }}" required />
                </div>
                <div>
                ...
                <div>
                    ...
                    <select name="" id="text-owner"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <option selected disabled>เลือก</option>
                        <option value="N" <?php echo $item['owner_shop'] === 'N' ? 'selected' : ''; ?>>ร้านค้าทั่วไป</option>
                        <option value="Y" <?php echo $item['owner_shop'] === 'Y' ? 'selected' : ''; ?>>ร้านค้า CPN</option>
                    </select>
                </div>
                <div>
                    <label for="text-1" class="mb-2 text-sm font-medium text-gray-900 dark:text-white">จุดร้านค้า</label>
                    <input type="text" id="text-1" name="" placeholder="จุดขายที่ 13"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        value="{{ $item['vendor_food'] }}" required />
                </div>
                <div>
                    ...
                    <input type="text" id="text-2" name="" placeholder="จุดขายที่ 13"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        value="{{ $item['vendor_subfood'] }}" required />
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" id="text-8" name="" placeholder="..."
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        value="{{ $item['vendor_locate'] }}" required />
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" id="text-12" name="" placeholder="..."
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        value="{{ $item['vendor_batchno'] }}" required />
                </div>
                <div>
                    ...
                    <input type="text" id="text-13" name="" placeholder="..."
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        value="{{ $item['billcount'] }}" required />
                </div>
                <div>
                    <label for="text-14" class="mb-2 text-sm font-medium text-gray-900 dark:text-white">เลขสัญญา Consign</label>
