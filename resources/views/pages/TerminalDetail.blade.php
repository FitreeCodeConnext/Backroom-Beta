...
@section('content')
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="#"
                            class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Terminal-Details
                            Terminal ID : {{ $term_id }}
                        </a>
                    </div>
                </li>
    ...
    <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Terminal-Details
        </h3>
    </div>
        ...
        <form action="{{ route('terminal-update', $term_id) }}" method="post">
            ...
            @foreach ($datagroup as $item)
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    ...
                    <div>
                        <label for="countries" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Activate
                            Flag</label>
                        <select name="activeflag"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option selected disabled>เลือก</option>
                            <option value="0" <?php echo $item['activeflag'] === '0' ? 'selected' : ''; ?>>ปิด</option>
                            <option value="1" <?php echo $item['activeflag'] === '1' ? 'selected' : ''; ?>>เปิด</option>
                        </select>
                    </div>
                    <div>
    ...
    <button type="button" class="text-white focus:outline-non bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900 mt-2 ">
        <a href="{{ route('terminal.index') }}">
            Cancel
        </a>
    </button>
