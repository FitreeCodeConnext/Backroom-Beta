                        ...
                        <div class="grid gap-6 mb-6 md:grid-cols-4 mt-2">
                            ...
                            <div class="flex items-center mb-6">
                                ...
                                <label for="checkbox-back-10"
                                    class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">ทะเบียนข้อมูลสินค้า
                                    Product</label>
                            </div>
                            {{-- 11 --}}
                            <div class="flex items-center mb-6">
                            ...
                            <div class="flex items-center mb-6">
                                ...
                                <label for="checkbox-back-14"
                                    class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">ทะเบียนข้อมูลกลุ่มสินค้า
                                    SAP</label>
                            </div>
                            {{-- 15 --}}
                            <div class="flex items-center mb-6">
                            ...
                            <div class="flex items-center mb-6">
                                ...
                                <label for="checkbox-back-23"
                                    class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">รายงานเกี่ยวกับ Item
                                    สินค้า</label>
                            </div>
                            {{-- 24 --}}
                            <div class="flex items-center mb-6">
                            ...
                            <div class="flex items-center mb-6">
                                ...
                                <label for="checkbox-back-32"
                                    class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">ข้อมูล LOG
                                    File</label>
                            </div>
                            {{-- 33 --}}
                            <div class="flex items-center mb-6">
                            ...
                            <div class="flex items-center mb-6">
                                ...
                                <label for="checkbox-back-40"
                                    class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">จัดทำบัตร
                                    Prepaid</label>
                            </div>
                            {{-- 41 --}}
                            <div class="flex items-center mb-6">
                            ...
                            <div class="flex items-center mb-6">
                                ...
                                <label for="checkbox-back-44"
                                    class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">ขัดทำ Invoice
                                    ร้านค้า</label>
                            </div>
                            {{-- 45 --}}
                            <div class="flex items-center mb-6">
                                ...
                                <label for="checkbox-back-45"
                                    class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">นำข้อมูลส่ง
                                    ERP</label>
                            </div>
                            {{-- 46 --}}
                            <div class="flex items-center mb-6">
